...
class NetConfigFactory():
    ...
    def removeOldConfig(self):
        ...
        j.system.fs.writeFile(filename="/etc/default/lxc-net", contents="USE_LXC_BRIDGE=\"false\"",
...
"""
    ...
    def setBackplaneWithBond(self, bondname, bondinterfaces, backplanename='backplane', ipaddr="192.168.10.10/24",
                             gw=""):
        """
        DANGEROUS, will remove old configuration
        """
